...
#
# DFTZynq_prj_flow.tcl: Tcl script for re-creating project 'DFTZynq'
#
# Generated by Vivado on Mon Dec 09 12:36:25 PST 2019
...
#
# 1. This project restoration tcl script (DFTZynq_prj_flow.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/u/wing/steve/icarus/phase_correlator/dft_genv/test_zynq/DFTZynq/DFTZynq.srcs/sources_1/bd/System/hdl/System_wrapper.v"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/u/wing/steve/icarus/phase_correlator/dft_genv/test_zynq/ver/BUILD.v"
#    "/home/u/wing/steve/icarus/phase_correlator/dft_genv/test_zynq/ver/DFT_FPGA.v"
#    "/home/u/wing/steve/icarus/phase_correlator/dft_genv/test_zynq/ver/idft_slice.v"
#    "/home/u/wing/steve/icarus/phase_correlator/dft_genv/test_zynq/ver/DFT_FPGA_WRAP.v"
#
#*****************************************************************************************
...
set script_file "DFTZynq_prj_flow.tcl"
...
set_property -name "board_part_repo_paths" -value "/home/u/wing/steve/.Xilinx/Vivado/2019.1/xhub/board_store" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/../ver/BUILD.v"] \
 [file normalize "${origin_dir}/../ver/DFT_FPGA.v"] \
 [file normalize "${origin_dir}/../ver/idft_slice.v"] \
 [file normalize "${origin_dir}/../ver/DFT_FPGA_WRAP.v"] \
]
add_files -norecurse -fileset $obj $files

# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/DFTZynq.srcs/sources_1/bd/System/hdl/System_wrapper.v" ]\
]
set imported_files [import_files -fileset sources_1 $files]

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../ver/DFT_FPGA.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../ver/idft_slice.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
if { [get_files BUILD.v] == "" } {
  import_files -quiet -fileset sources_1 /home/u/wing/steve/icarus/phase_correlator/dft_genv/test_zynq/ver/BUILD.v
}
if { [get_files DFT_FPGA.v] == "" } {
  import_files -quiet -fileset sources_1 /home/u/wing/steve/icarus/phase_correlator/dft_genv/test_zynq/ver/DFT_FPGA.v
}
if { [get_files idft_slice.v] == "" } {
  import_files -quiet -fileset sources_1 /home/u/wing/steve/icarus/phase_correlator/dft_genv/test_zynq/ver/idft_slice.v
}
if { [get_files DFT_FPGA_WRAP.v] == "" } {
  import_files -quiet -fileset sources_1 /home/u/wing/steve/icarus/phase_correlator/dft_genv/test_zynq/ver/DFT_FPGA_WRAP.v
}
...
# DFT_FPGA_WRAP
  ...
  # Create instance: DFT_FPGA_WRAP_0, and set properties
  set block_name DFT_FPGA_WRAP
  set block_cell_name DFT_FPGA_WRAP_0
  if { [catch {set DFT_FPGA_WRAP_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $DFT_FPGA_WRAP_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins DFT_FPGA_WRAP_0/AXI_S] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins DFT_FPGA_WRAP_0/AXI_S_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins DFT_FPGA_WRAP_0/AXI_S_ARESETn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x01000000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs DFT_FPGA_WRAP_0/AXI_S/reg0] SEG_DFT_FPGA_WRAP_0_reg0
...
preplace port FIXED_IO -pg 1 -lvl 4 -x 1160 -y -220 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 240 -y -170 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -x 970 -y -190 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 2 -x 620 -y -70 -defaultsOSRD
preplace inst DFT_FPGA_WRAP_0 -pg 1 -lvl 1 -x 240 -y 30 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 120 440 -170 810
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 N -90
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 0 3 30 130 450J 100 820
preplace netloc processing_system7_0_DDR 1 1 3 NJ -250 800 -70 1130
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ -230 790 -60 1140
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 440J -240 820
preplace netloc ps7_0_axi_periph_M00_AXI 1 0 4 40 110 NJ 110 NJ 110 1120
levelinfo -pg 1 0 240 620 970 1160
pagesize -pg 1 -db -bbox -sgen 0 -300 1270 190
"
}
